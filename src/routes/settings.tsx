...
function SettingsPage() {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      // Persist integration settings to user metadata
  ...
  return (
    <div className="px-4 lg:px-8 py-6 sm:py-8 max-w-5xl mx-auto space-y-6">
      <SectionHeading
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-4 gap-6">
        ...
        <div className="flex flex-row lg:flex-col gap-1 overflow-x-auto pb-2 lg:pb-0 shrink-0 -mx-4 px-4 lg:mx-0 lg:px-0">
          <button className="flex-shrink-0 flex items-center gap-2 px-4 py-3 rounded-lg text-sm font-mono transition-colors bg-primary/10 text-primary border border-primary/20 whitespace-nowrap">
            <User className="h-4 w-4" /> Profile Info
          </button>
          <button className="flex-shrink-0 flex items-center gap-2 px-4 py-3 rounded-lg text-sm font-mono text-muted-foreground transition-colors hover:bg-white/5 hover:text-white whitespace-nowrap">
          ...
          <button
            ...
            className="flex-shrink-0 flex items-center gap-2 px-4 py-3 rounded-lg text-sm font-mono text-destructive/70 transition-colors hover:bg-destructive/10 hover:text-destructive lg:mt-8 whitespace-nowrap"
          >
