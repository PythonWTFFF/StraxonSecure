...
const divisions = [
  { name: "Creative", logo: creativeLogo, glow: "drop-shadow-[0_0_12px_#ff4ecd]" },
  { name: "Develop", logo: devLogo, glow: "drop-shadow-[0_0_12px_#3b82f6]" },
  { name: "Secure", logo: secureLogo, glow: "drop-shadow-[0_0_12px_#22c55e]" },
];
