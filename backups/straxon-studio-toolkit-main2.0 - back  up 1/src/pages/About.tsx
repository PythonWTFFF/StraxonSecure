...
const divisions = [
  {
    ...
    logo: creativeLogo,
    glow: "drop-shadow-[0_0_15px_#ff4ecd]",
  },
  {
    ...
    logo: devLogo,
    glow: "drop-shadow-[0_0_15px_#3b82f6]",
  },
  {
    name: "STRAXON Secure",
    ...
    logo: secureLogo,
    glow: "drop-shadow-[0_0_15px_#22c55e]",
  },
];
...
const About = () => {
  ...
  src={div.logo}
  alt={div.name}
  className={`h-12 w-12 sm:h-14 sm:w-14 object-contain transition-all duration-300 group-hover:scale-110 ${div.glow}`}
/>
