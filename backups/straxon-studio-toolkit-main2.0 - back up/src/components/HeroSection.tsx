...
const divisionLogos = [
  { icon: Palette, label: "STRAXON Creative", letter: "C" },
  { icon: Code, label: "STRAXON Develop", letter: "D" },
  { icon: Shield, label: "STRAXON Secure", letter: "S" },
];
          ...
          {divisionLogos.map((div, i) => (
            ...
            >
              <div className="h-14 w-14 sm:h-18 sm:w-18 md:h-20 md:w-20 rounded-xl sm:rounded-2xl border-2 border-dashed border-primary/40 bg-primary/5 flex items-center justify-center relative group hover:border-primary/70 transition-colors cursor-default">
                <div.icon className="h-6 w-6 sm:h-8 sm:w-8 text-primary/40 group-hover:text-primary transition-colors" />
                <span className="absolute -bottom-2 sm:-bottom-3 text-[7px] sm:text-[9px] font-mono text-muted-foreground bg-background px-1 sm:px-2 whitespace-nowrap">YOUR LOGO</span>
              </div>
