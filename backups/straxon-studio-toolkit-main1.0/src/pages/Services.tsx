              ...
              >
                ...
                <div className="flex-shrink-0 w-full lg:w-2/5">
                  <motion.div
                    ...
                    className="relative aspect-square max-w-sm mx-auto rounded-2xl border border-border bg-card overflow-hidden flex items-center justify-center group cursor-pointer"
                  >
        ...
        <section className="py-20 bg-secondary/30">
          <div className="container mx-auto px-6 text-center">
            <motion.div {...fadeUp}>
              ...
              <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Let's discuss how we can engineer the perfect solution for your business.</p>
